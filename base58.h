...
inline string PrivKeyToSecret(uint256 privkey)
{
    // add 1-byte version number to the front
    vector<unsigned char> vch(1, PRIVKEYVERSION);
...
inline bool SecretToPrivKey(const string& str, uint256& privkeyRet)
{
...
inline bool IsValidBitcoinSecret(const string& str)
{
